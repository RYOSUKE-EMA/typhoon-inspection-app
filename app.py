...
INSPECTION_TYPES = {
    ...
    "disaster": {
        ...
        "checklist": [
            ...
            "足場脚部の沈下の有無",
            "足場脚部の敷板への固定・根がらみの状況",
            "壁つなぎ（間隔・締付け・アンカー）の状況",
            "壁つなぎがとれていない場合の足場の控えの有無",
            "足場上に物は置いてないか（やむを得ない場合の固定はしてあるか）",
            "足場全体各部の締付部の点検",
            "隅各部の頂部火打材はしてあるか（高層の場合、2層毎設置が望ましい）",
            "枠組足場（ブレース・アームロック）の点検",
            "単管・くさび緊結式足場の大筋交いの状況",
            "朝顔の点検",
            "工事用シートの巻き取り・撤去（風圧減少効果＝特に地表3層）",
            "養生用シートの巻き取り・撤去（枠組足場が躯体より突出している場合）",
            "強風が開口部を貫通する場合の風対策（特に風下側）",
            "吊足場の状況",
            "移動式足場の移動・転倒対策",
            "その他（足場関係）",
            # その他・建築物
            ...
            "飛散、破壊が懸念される重要物品の退避",
            "主要構造部（柱・梁等）の被災の有無",
            "外装材（屋根材・外壁材・樋類）の被災の有無",
            "ガラス等飛散物品の状況",
            "アンテナ、設備ダクト、看板等附属品の被災の有無",
            "地盤状況（隆起、陥没、亀裂、液状化等）",
            "浸水、湛水、洪水その他の情報把握体制",
            "強風等が納まった時、各部の緊結部や接合部の緩みの点検",
        ],
    },
}
